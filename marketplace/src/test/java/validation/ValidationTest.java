...
class ValidationTest {
    ...
    @Test
    void  nomeLojaValido(){
        String marcaNomeLojaValido = "Uma nova loja";
        assertTrue(Validation.nomeLojaValido(marcaNomeLojaValido));
        String marcaNomeLojaInvalido = "djaskldj*/*";
        assertFalse(Validation.nomeLojaValido(marcaNomeLojaInvalido));
    }

    @Test
    void  CnpjValido(){
        String marcaCnpjValido = "93.763.071/0001-27";
        assertTrue(Validation.CnpjValido(marcaCnpjValido));
        String marcaCnpjInvalido = "dja.586.skldj";
        assertFalse(Validation.CnpjValido(marcaCnpjInvalido));
    }
}